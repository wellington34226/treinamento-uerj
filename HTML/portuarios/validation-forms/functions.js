...
function selectType(obj) {
  let inputConfirmed = document.getElementById("confirmed");
  let textAutorized = document.getElementById("text_autorized");
  let buttonSubmit = document.getElementById("join_submit");
  if(inputConfirmed !== null && textAutorized !== null && buttonSubmit !== null){
    buttonSubmit.disabled = true;
    inputConfirmed.checked = false;
    if(obj.id === "docas"){
      textAutorized.innerHTML = "Autorizo o desconto de 3% do salário base em folha de pagamento.";
    }else if(obj.id === "aposentados"){
      textAutorized.innerHTML = "Autorizo o desconto de 5% do salário mínimo.";
    }else if(obj.id === "trabalhador"){
      textAutorized.innerHTML = "Autorizo o desconto de 5% da mensalidade (DAS).";
    }
  }
}
/*
